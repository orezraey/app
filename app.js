...
function list(path, id = '', fallback = false) {
    ...
    <div class="container" id="select_items" style="padding: 0px 50px 10px; display:none;">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div>
          <button id="handle-multiple-items-copy" style="padding: 5px 10px; font-size: 12px; margin-right: 5px;" class="btn btn-success">Copy</button>
          <button id="handle-multiple-items-download" style="padding: 5px 10px; font-size: 12px;" class="btn btn-primary">Download</button>
        </div>
      </div>
    </div>
...
// Show download progress notification - DISABLED
function showDownloadProgress(fileCount) {
    // Function disabled to prevent progress pop-ups
    return;
}

// Update download progress - DISABLED
function updateDownloadProgress(current, total) {
    // Function disabled to prevent progress pop-ups
    return;
}

// Hide download progress - DISABLED
